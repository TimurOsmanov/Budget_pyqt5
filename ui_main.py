...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QRect(0, 0, 300, 120))
        ...
        self.Button1_Rollup.setStyleSheet(u"QPushButton {\n"
                                          ...
                                          "}")
        icon3 = QIcon()
        icon3.addFile(u"cp_b1_min.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Button1_Rollup.setIcon(icon3)
        ...
        self.Button2_Max.setStyleSheet(u"QPushButton {\n"
                                       ...
                                       "")
        icon4 = QIcon()
        icon4.addFile(u"cp_b2_resize.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Button2_Max.setIcon(icon4)
        ...
        self.Button3_Exit.setStyleSheet(u"QPushButton {\n"
                                        ...
                                        "}")
        icon5 = QIcon()
        icon5.addFile(u"cp_b3_close.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Button3_Exit.setIcon(icon5)
        ...
        if (self.Page2_Main.columnCount() < 4):
            self.Page2_Main.setColumnCount(4)
        ...
        self.Page2_Main.setGeometry(QRect(62, 135, 500, 690))
        font7 = QFont()
        ...
        self.Page3_Main.setHorizontalHeaderItem(0, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.Page3_Main.setHorizontalHeaderItem(1, __qtablewidgetitem5)
        __qtablewidgetitem6 = QTableWidgetItem()
        self.Page3_Main.setHorizontalHeaderItem(2, __qtablewidgetitem6)
        self.Page3_Main.setObjectName(u"Page3_Main")
        self.Page3_Main.setGeometry(QRect(62, 135, 400, 690))
        ...
        self.StackedWidget_frame.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Control_label.setText(QCoreApplication.translate("MainWindow",
                                                              u"                     \u0423\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435",
                                                              None))
        self.Button2.setText(QCoreApplication.translate("MainWindow",
                                                        u"    \u041e\u043f\u0435\u0440\u0430\u0446\u0438\u0438 \u0437\u0430 \u0442\u0435\u043a\u0443\u0449\u0438\u0439 \u043c\u0435\u0441\u044f\u0446",
                                                        None))
        self.Button1.setText(QCoreApplication.translate("MainWindow",
                                                        u"    \u0412\u043d\u0435\u0441\u0442\u0438 \u043e\u043f\u0435\u0440\u0430\u0446\u0438\u044e / \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u044e",
                                                        None))
        self.Button3.setText(QCoreApplication.translate("MainWindow",
                                                        u"    \u0422\u0430\u0431\u043b\u0438\u0446\u0430 \u0437\u0430 \u0442\u0435\u043a\u0443\u0449\u0438\u0439 \u043c\u0435\u0441\u044f\u0446",
                                                        None))
        self.Current_option.setText("")
        # if QT_CONFIG(tooltip)
        self.Button1_Rollup.setToolTip(
            QCoreApplication.translate("MainWindow", u"\u0421\u0432\u0435\u0440\u043d\u0443\u0442\u044c", None))
        # endif // QT_CONFIG(tooltip)
        self.Button1_Rollup.setText("")
        # if QT_CONFIG(tooltip)
        self.Button2_Max.setToolTip(
            QCoreApplication.translate("MainWindow", u"\u0420\u0430\u0437\u0432\u0435\u0440\u043d\u0443\u0442\u044c",
                                       None))
        # endif // QT_CONFIG(tooltip)
        self.Button2_Max.setText("")
        # if QT_CONFIG(tooltip)
        self.Button3_Exit.setToolTip(
            QCoreApplication.translate("MainWindow", u"\u0417\u0430\u043a\u0440\u044b\u0442\u044c", None))
        # endif // QT_CONFIG(tooltip)
        self.Button3_Exit.setText("")
        self.Insert_info.setText("")
        self.Insert_2.setText(
            QCoreApplication.translate("MainWindow", u"\u0412\u0441\u0442\u0430\u0432\u0438\u0442\u044c", None))
        self.Insert_info_2.setText("")
        self.Insert_2_label.setText(QCoreApplication.translate("MainWindow",
                                                               u"\u0412\u043d\u0435\u0441\u0442\u0438 \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u044e",
                                                               None))
        self.Insert_1_label.setText(QCoreApplication.translate("MainWindow",
                                                               u"\u0412\u043d\u0435\u0441\u0442\u0438 \u043e\u043f\u0435\u0440\u0430\u0446\u0438\u044e",
                                                               None))
        self.Insert.setText(
            QCoreApplication.translate("MainWindow", u"\u0412\u0441\u0442\u0430\u0432\u0438\u0442\u044c", None))
        self.label_7.setText(
            QCoreApplication.translate("MainWindow", u"\u041a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u044f", None))
        ...
        self.Show2.setText(
            QCoreApplication.translate("MainWindow", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow",
                                                        u"\u0414\u043b\u044f \u043e\u0442\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f \u0442\u0430\u0431\u043b\u0438\u0446\u044b \u0437\u0430 \u043f\u0435\u0440\u0438\u043e\u0434 \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043d\u0430\u0447\u0430\u043b\u044c\u043d\u0443\u044e \u0438 \u043a\u043e\u043d\u0435\u0447\u043d\u0443\u044e \u0434\u0430\u0442\u0443 \u0438 \u043d\u0430\u0436\u043c\u0438\u0442\u0435 \u043d\u0430 \u043a\u043d\u043e\u043f\u043a\u0443 \"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c\"",
                                                        None))
        ...
        self.Show3.setText(
            QCoreApplication.translate("MainWindow", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c", None))
        ___qtablewidgetitem4 = self.Page3_Main.horizontalHeaderItem(0)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow",
                                                                u"\u0414\u043e\u0445\u043e\u0434 / \u0420\u0430\u0441\u0445\u043e\u0434",
                                                                None));
        ___qtablewidgetitem5 = self.Page3_Main.horizontalHeaderItem(1)
        ___qtablewidgetitem5.setText(
            QCoreApplication.translate("MainWindow", u"\u041a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u044f", None));
        ___qtablewidgetitem6 = self.Page3_Main.horizontalHeaderItem(2)
